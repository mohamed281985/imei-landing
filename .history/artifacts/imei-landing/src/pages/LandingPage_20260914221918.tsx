...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background font-sans overflow-x-hidden" dir="rtl">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex items-center justify-between h-20 md:h-24">
            ...
            <nav className="hidden lg:flex items-center gap-6 md:gap-8 text-sm font-medium text-foreground/80">
              ...
              <Link href="/terms-and-conditions"><a className="hover:text-primary transition-colors">شروط الاستخدام</a></Link>
              <Link href="/privacy-policy"><a className="hover:text-primary transition-colors">سياسة الخصوصية</a></Link>
            </nav>
      ...
      <section
        id="hero"
        className="relative min-h-screen md:min-h-[80vh] flex items-center overflow-hidden pt-16 md:pt-20"
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-0 md:space-x-8 items-center">
            ...
            >
              ...
              >
                ...
                >
                  <span className="inline-flex items-center"><Search size={16} /></span>
                  فحص IMEI الآن
                </motion.a>
              </motion.div>
              ...
              >
                ...
                <div className="text-right">
                  <div className="flex items-center gap-1" dir="ltr">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className={`w-3.5 h-3.5 md:w-4 md:h-4 ${i < 4 ? "fill-yellow-400 text-yellow-400" : "fill-yellow-200 text-yellow-200"}`} />
                    ))}
            ...
            <div className="relative w-full mb-10 md:mb-0 order-1 md:order-2 flex justify-center items-center overflow-visible">
              <motion.img
                ...
                className="w-full max-w-115 md:max-w-135 md:scale-125 h-auto drop-shadow-2xl relative z-10 object-contain mx-auto"
              />
              ...
              <motion.div
                ...
                className="absolute top-[8%] right-[20%] md:top-[12%] md:right-[15%] lg:top-[15%] lg:right-[10%] bg-white rounded-md shadow-sm p-1 md:p-1.5 z-20 w-[28vw] md:w-[22vw] lg:w-35"
              >
                <div className="flex items-center gap-1">
                  <div className="w-4 h-4 md:w-5 md:h-5 lg:w-5 lg:h-5 rounded-full bg-green-100 flex items-center justify-center shrink-0">
              ...
              <motion.div
                ...
                className="absolute bottom-[35%] left-[20%] md:bottom-[40%] md:left-[15%] lg:bottom-[45%] lg:left-[10%] bg-white rounded-md shadow-sm p-1 md:p-1.5 z-20 w-[28vw] md:w-[22vw] lg:w-35"
              >
                <div className="flex items-center gap-1">
                  <div className="w-4 h-4 md:w-5 md:h-5 lg:w-5 lg:h-5 rounded-full bg-blue-100 flex items-center justify-center shrink-0">
              ...
              <motion.div
                ...
                className="absolute top-[50%] right-[15%] md:top-[55%] md:right-[10%] lg:top-[60%] lg:right-[5%] bg-white rounded-md shadow-sm p-1 md:p-1.5 z-20 w-[28vw] md:w-[22vw] lg:w-35"
              >
                <div className="flex items-center gap-1">
                  <div className="w-4 h-4 md:w-5 md:h-5 lg:w-5 lg:h-5 rounded-full bg-orange-100 flex items-center justify-center shrink-0">
              ...
              <motion.div
                ...
                className="absolute top-[65%] left-[15%] md:top-[70%] md:left-[10%] lg:top-[75%] lg:left-[5%] bg-white rounded-md shadow-sm p-1 md:p-1.5 z-20 w-[28vw] md:w-[22vw] lg:w-35"
              >
                <div className="flex items-center gap-1">
                  <div className="w-4 h-4 md:w-5 md:h-5 lg:w-5 lg:h-5 rounded-full bg-purple-100 flex items-center justify-center shrink-0">
              ...
              <motion.div
                ...
                className="absolute bottom-[25%] right-[20%] md:bottom-[30%] md:right-[15%] lg:bottom-[35%] lg:right-[10%] bg-white rounded-md shadow-sm p-1 md:p-1.5 z-20 w-[28vw] md:w-[22vw] lg:w-35"
              >
                <div className="flex items-center gap-1">
                  <div className="w-4 h-4 md:w-5 md:h-5 lg:w-5 lg:h-5 rounded-full bg-indigo-100 flex items-center justify-center shrink-0">
      ...
      <section className="py-16 md:py-20 bg-linear-to-b from-white to-[#EEF4FF] overflow-hidden">
          ...
          <div className="animate-scroll-x">
            {[splash, homeScreen, imeiSearch, reportLost, registerPhone, splash, homeScreen, imeiSearch, reportLost, registerPhone].map((img, i) => (
              <div key={i} style={{ width: "clamp(120px, 20vw, 230px)", flexShrink: 0, padding: "0 8px" }}>
                <div className="rounded-3xl md:rounded-[28px] overflow-hidden border-[5px] md:border-[6px] border-white shadow-xl shadow-primary/10"
      ...
      <section id="pricing" className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
            ...
            <Card className="border-secondary shadow-xl relative overflow-hidden scale-100 lg:scale-105 z-10 flex flex-col bg-linear-to-b from-[#FFFDF0] to-white">
      ...
      <section className="py-16 md:py-20 bg-[#0D2137] text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-base md:text-xl text-blue-200 mb-6 md:mb-10">تواصل مع فريق الدعم عبر واتساب أو حمّل التطبيق الآن</p>
