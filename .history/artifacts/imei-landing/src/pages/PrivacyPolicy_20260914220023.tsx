...
const translations = {
  ...
  en: {
    ...
    supportText: "For any privacy or account questions, you can contact us by email:",
    footer: "Back to Home",
    ...
    sections: [
      {
        ...
        content: [
          "Account data: We collect your email address and encrypted password only to create and manage your account, verify your identity, and support subscriptions inside the app.",
          "Device identifiers (Google-required): We do not collect, store, or send your original IMEI to the servers in plain form. The IMEI is converted locally on the device into a non-reversible SHA-256 hash before being sent, ensuring maximum privacy and preventing direct linkage between hardware identity and personal identity.",
          "Optional contact info: In premium plans, you may choose to share your phone number or WhatsApp link to make it easier to contact you if your lost device is found.",
        ],
      },
      {
        title: "2. Plan Function and Identity Protection",
        content: [
          "Free plan: When a lost device is scanned under the free plan, no contact or personal data is shown to the finder on the website. A secure internal message box protected by Cloudflare Turnstile and rate limiting prevents abuse, and the finder may leave their contact details voluntarily for internal secure notification.",
          "Paid plans (Silver / Gold): Users receive an explicit checkbox. If enabled willingly and clearly during a lost-device report, the system may display the phone number or WhatsApp button on the website for direct contact. Users may revoke permission at any time.",
        ],
      },
      {
        title: "3. Data Security and Storage",
        content: [
          "All data exchanged between the app and server is protected by encrypted HTTPS / SSL communication.",
          "Data is stored in secure environments with strict access policies and Row Level Security (RLS), ensuring no unauthorized user can access another user’s device data.",
        ],
      },
      {
        title: "4. Device Ownership Transfer",
        content: [
          "Ownership transfer operations rely on encrypted digital authentication based on active accounts, protected user IDs, and temporary passwords or verification codes. We do not require plain IMEI values or personal details to be shared on a single interface between buyer and seller, in alignment with marketplace rules against linking permanent device IDs to personal identity.",
        ],
      },
      {
        title: "5. Updates to This Privacy Policy",
        content: [
          "We reserve the right to update this policy to reflect technical, legal, or regulatory changes. We will notify users of material changes through the app, and continued use after the update constitutes explicit consent to the revised version.",
        ],
      },
      {
        title: "6. User Rights and Contact",
        content: [
          "Under applicable law, you may review, update, or request deletion of your account and registered devices at any time. For questions or data deletion requests, contact our technical support at imeisafe@gmail.com.",
        ],
      },
    ],
  },
...
export default function PrivacyPolicy() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f8ff] text-slate-800" dir={isArabic ? "rtl" : "ltr"}>
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <main className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm sm:p-8 lg:p-10">
          <div className="mb-8 rounded-2xl border border-emerald-100 bg-emerald-50 p-4 text-sm leading-7 text-emerald-900">
            <p className="font-bold">{content.noticeTitle}</p>
          ...
          <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-5">
            ...
            <p className="text-base leading-8 text-slate-700">
              {content.supportText} <a href="mailto:imeisafe@gmail.com" className="font-bold text-sky-700">imeisafe@gmail.com</a>
            </p>
          </div>
